...
class Organization(models.Model):
    path = models.SlugField(
        max_length=32, unique=True, help_text="The path of the organization."
    )
    name = models.CharField(
        max_length=128, help_text="The descriptive name of the organization"
    )
    description = models.CharField(
        max_length=1024, help_text="A short text describing the organization"
    )
