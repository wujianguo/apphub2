...
# {'code': 0, 'data': {'packageName': 'top.libms.app.apphub', 'status': 1, 'errorReason': '', 'packetType': 0}, 'msg': 'success', 'subCode': '0', 'timestamp': 1644913835799}
# {'code': 0, 'data': {'packageName': 'top.libms.app.apphub', 'status': 3, 'errorReason': '', 'packetType': 0}, 'msg': 'success', 'subCode': '0', 'timestamp': 1644913869475}
# {'code': 0, 'data': {'packageName': 'top.libms.app.apphub', 'status': 4, 'errorReason': '文件地址不合法，无法进行下载', 'packetType': 0}, 'msg': 'success', 'subCode': '0', 'timestamp': 1645153147163}
