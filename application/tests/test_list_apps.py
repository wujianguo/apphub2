...
class UserUniversalAppListTest(BaseTestCase):
    ...
    def test_more_than_one_page(self):
        ...
        for i in range(10):
            ...
            self.assert_partial_dict_equal(
                resp_app_list2[i], app_list[i + 10], ["name"]
            )
        ...
        for i in range(10):
            ...
            self.assert_partial_dict_equal(
                resp_app_list2[i], app_list[i + 20], ["name"]
            )
        ...
        for i in range(6):
            ...
            self.assert_partial_dict_equal(
                resp_app_list2[i], app_list[i + 30], ["name"]
            )
...
class UserVisibleAppListTest(BaseTestCase):
    ...
    def test_visible_apps(self):
        ...
        larry_org1 = self.create_and_get_org_namespace(
            larry, "larry_org1", visibility="Public"
        )
        ...
        larry_org2 = self.create_and_get_org_namespace(
            larry, "larry_org2", visibility="Internal"
        )
        ...
        larry_org3 = self.create_and_get_org_namespace(
            larry, "larry_org3", visibility="Private"
        )
        ...
        bill_org1 = self.create_and_get_org_namespace(
            bill, "bill_org1", visibility="Public"
        )
        ...
        bill_org2 = self.create_and_get_org_namespace(
            bill, "bill_org2", visibility="Internal"
        )
        ...
        bill_org3 = self.create_and_get_org_namespace(
            bill, "bill_org3", visibility="Private"
        )
